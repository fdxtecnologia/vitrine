...
function new(listProds,vImages,parentGroup)
 
    local nImages = #listProds;
    local range = 360
    local sectionSize = math.ceil(range / nImages)
    local xCentre = display.contentWidth / 2
    local yCentre = display.contentHeight / 2
    local diameter = display.contentWidth - xCentre/2
    local r = diameter / 2
    local points = {}
    local images = vImages;
